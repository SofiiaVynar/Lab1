...
public class Helicopter extends Aircraft {
    public static final String HEADER = "ID, model, currentAltitude, maxAltitude, fuelCapacity, currentFuel";
    ...
    public String toCSV() {
        return super.toCSV() + "," + ID + "," + model + "," + currentAltitude
                + "," + maxAltitude + "," + fuelCapacity + "," + currentFuel;
    }
}
